...
def format_interface_status(json_data):
    interfaces = json_data['imdata']
    header = "Interface Status\n" + "=" * 80
    title = "\n{:<50} {:<20} {:<8} {:<6}".format("DN", "Description", "Speed", "MTU")
    separator = "\n" + "-" * 80

    output = header + title + separator
    for interface in interfaces:
        attrs = interface['l1PhysIf']['attributes']
        dn = attrs['dn']
        speed = attrs.get('speed', 'N/A')  
        mtu = attrs.get('mtu', 'N/A')     
        output += "\n{:<50} {:<20} {:<8} {:<6}".format(dn, '', speed, mtu)
